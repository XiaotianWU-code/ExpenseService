...
namespace Expense.Service.Test
{
    public class ExpenseServiceTest
    {
        ...
        {
            // given
            Project projet = new Project(ProjectType.INTERNAL, "internal type");
            // when
            ExpenseType expenseType = ExpenseService.GetExpenseCodeByProjectTypeAndName(projet);
            // then
        ...
        {
            // given
            Project projet = new Project(ProjectType.EXTERNAL, "Project A");
            // when
            ExpenseType expenseType = ExpenseService.GetExpenseCodeByProjectTypeAndName(projet);
            // then
        ...
        {
            // given
            Project projet = new Project(ProjectType.EXTERNAL, "Project B");
            // when
            ExpenseType expenseType = ExpenseService.GetExpenseCodeByProjectTypeAndName(projet);
            // then
        ...
        {
            // given
            Project projet = new Project(ProjectType.EXTERNAL, "Project C");
            // when
            ExpenseType expenseType = ExpenseService.GetExpenseCodeByProjectTypeAndName(projet);
            // then
        ...
        {
            // given
            Project projet = new Project(ProjectType.UNEXPECTED_PROJECT_TYPE, "Project C");

            // then
            Assert.Throws<UnexpectedProjectTypeException>(() => ExpenseService.GetExpenseCodeByProjectTypeAndName(projet));
        }
    }
}